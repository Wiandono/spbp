...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
	...
	<div class="content-wrapper">
		<div class="container-fluid">
			...
			<?php 
				echo form_open_multipart('control_admin/updateBook');
			...
			<div class="row">
				<div class="col-12">
					<div class="form-group row">
						...
						<div class="col-sm-8">
							<input id="judulBuku" class="form-control" name="title" type="text" placeholder="Harry Potter" value="<?php echo $result[0]->judul ?>">
						</div>
					</div>
					<div class="form-group row">
						<label for="isbn" class="col-sm-2 col-form-label offset-sm-1">ISBN</label>
						<div class="col-sm-8">
							<input id="isbn" class="form-control" name="isbn" type="number" placeholder="9786025406164" value="<?php echo $result[0]->isbn ?>">
						</div>
					</div>
					<div class="form-group row">
						<label for="kategori" class="col-sm-2 col-form-label offset-sm-1">Kategori</label>
						<div class="col-sm-8">
							<input id="kategori" class="form-control" name="category" type="text" placeholder="Kuliner" value="<?php echo $result[0]->kategori ?>">
						</div>
					</div>
					<div class="form-group row">
						<label for="bahasa" class="col-sm-2 col-form-label offset-sm-1">Bahasa</label>
						<div class="col-sm-8">
							<input id="bahasa" class="form-control" name="language" type="text" placeholder="Indonesia" value="<?php echo $result[0]->bahasa ?>">
						</div>
					</div>
					<div class="form-group row">
						<label for="penulis" class="col-sm-2 col-form-label offset-sm-1">Penulis</label>
						<div class="col-sm-8">
							<input id="penulis" class="form-control" name="penulis" type="text" placeholder="Shah Rukh Khan" value="<?php echo $result[0]->penulis ?>">
						</div>
					</div>
					<div class="form-group row">
						<label for="penerbit" class="col-sm-2 col-form-label offset-sm-1">Penerbit</label>
						<div class="col-sm-8">
							<input id="penerbit" class="form-control" name="penerbit" type="text" placeholder="Gramedia" value="<?php echo $result[0]->penerbit ?>">
						</div>
					</div>
					<div class="form-group row">
						<label for="tanggalTerbit" class="col-sm-2 col-form-label offset-sm-1">Tanggal Terbit</label>
						<div class="col-sm-8">
							<input id="tanggalTerbit" class="form-control" name="tanggal" type="text" placeholder="YYYY-MM-DD" value="<?php echo $result[0]->tgl_terbit ?>">
						</div>
					</div>
					<div class="form-group row">
						<label for="halaman" class="col-sm-2 col-form-label offset-sm-1">Jumlah Halaman</label>
						<div class="col-sm-8">
							<input id="halaman" class="form-control" name="halaman" type="text" placeholder="745" value="<?php echo $result[0]->halaman ?>">
						</div>
					</div>
					<div class="form-group row">
						<label for="deskripsi" class="col-sm-2 col-form-label offset-sm-1">Deskripsi</label>
						<div class="col-sm-8">
							<textarea id="deskripsi" class="form-control" name="deskripsi" rows="3"><?php echo $result[0]->deskripsi ?></textarea>
						</div>
					</div>
					<div class="form-group row">
						<label for="stock" class="col-sm-2 col-form-label offset-sm-1">Stok</label>
						<div class="col-sm-8">
							<input id="stock" class="form-control" type="number" name="stock" placeholder="12" value="<?php echo $result[0]->stock ?>">
						</div>
					</div>
					<div class="form-group row justify-content-center">
						<input class="btn btn-primary mr-3" type="submit" value="Simpan" name="submit"/>
						<a class="btn btn-danger mr-3" data-toggle="modal" data-target="#deleteModal" href=#>Delete</a>
		...
		<div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">Select "Delete" below if you are sure to delete this book.</div>
					<div class="modal-footer">
						<button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
						<a href="<?php echo base_url(). "index.php/admin/deleteBook/". $result[0]->isbn ?>" class="btn btn-danger mr-3">Delete</a>
					</div>
				</div>
			</div>
		</div>
